...
const HomePage: React.FC = () => {
  ...
  const ermitsIntegration = [
    {
      name: 'ThreatIntel',
      description: 'Threat Intelligence & Risk Assessment',
      status: 'Connected',
      lastSync: '2 min ago'
    },
    {
    ...
    {
      name: 'EduSoluce',
      description: 'Security Training & Awareness',
      status: 'Connected',
      lastSync: '3 min ago'
    }
  ];
      ...
      <section className="py-24 bg-gradient-to-br from-gray-50 to-command-blue-50 dark:from-gray-900 dark:to-command-blue-900/20 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Seamless integration with the complete ERMITS cybersecurity platform suite
            </p>
          </motion.div>
          ...
          >
            {ermitsIntegration.map((product, index) => {
              return (
                <motion.div 
                  key={product.name}
                  variants={itemVariants}
